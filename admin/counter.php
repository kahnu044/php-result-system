...
class UserInfo{
 ...
 //find user referer link added(08-09-2020) 
...
//DETECT NEW IP AND STORE TO DATABASE
    ...
    $check_ip = mysqli_num_rows($result);
        if ($check_ip<1) {
    $sql = "INSERT INTO visitors(user_ip,page_url,user_device,user_os,user_browser,user_referer_link) VALUES ('$user_ip','$page_url','$user_device','$user_os','$user_browser','$user_referer_link')";
    $result = mysqli_query($conn,$sql);
    }
...
//UPDATE PAGE VIEWS PER PAGE URL BY VISTORS IP ALSO UPDATE REFERER LINK (08-09-2020 REFERER ADDED)
    $sql = "UPDATE visitors SET total_visit = total_visit+1,user_referer_link = '$user_referer_link' WHERE page_url ='$page_url'  AND user_ip = '$user_ip' ";
    $conn->query($sql);
