...
<head>
    ...
    <title>Delete Student : Kanha Result System</title>';
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card-header">
                                <strong>Search Student Here</strong> 
                            </div>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-12">
                                            <div class="input-group">
                                                ...
                                                <button type="submit" class="btn btn-primary" value="">Search</button></div>
                                            </div>
                                        </div>
                                    </div>   
                                </form>
 ...
 if ($recordFound) {
  ...
  while($row= mysqli_fetch_array($result1)){
                              echo '  <tr>
                                          ...
                                          <td>'.$row['exam_type'].'</td>
                                          <td><a href="searchView.php?id='.$row['id'].'" target="_blank"><button type="button" class="btn btn-primary">View</button></a></td>
